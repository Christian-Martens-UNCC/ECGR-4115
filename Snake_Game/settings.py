...
# Parameters
CELL_SIZE = 50 # number of pixels each side of the cell is
CELL_NUMBER = 12 # number of cells each side of the game screen is, must be >= 5
...
ALGO_PICK = 2 # 0: A* Algorithm, 1: BFS Algorithm, 2: Dijkstra Algorithm, 3: Mixed System
